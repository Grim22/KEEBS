...
function useUncontrolledProp2(propValue, defaultValue, handler) {
  var wasPropRef = (0, import_react13.useRef)(propValue !== void 0);
  var _useState = (0, import_react13.useState)(defaultValue), stateValue = _useState[0], setState = _useState[1];
  ...
  return [isProp2 ? propValue : stateValue, (0, import_react13.useCallback)(function(value) {
